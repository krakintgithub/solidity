...
//   }
  ...
  function setNewRouterContract(address newRouterAddress) onlyOwner public virtual returns(bool success) { //owner
    ...
    function transfer(address[2] memory addressArr, uint[2] memory uintArr) public virtual returns (bool success) { //from router
    ...
    function transferFrom(address[3] memory addressArr, uint[3] memory uintArr) public virtual returns (bool success) { //from router
    ...
    function approve(address[2] memory addressArr, uint[2] memory uintArr) public virtual returns (bool success){ //from router
    ...
    function increaseAllowance(address[2] memory addressArr, uint[2] memory uintArr) public virtual returns (bool success) { //from router
    ...
    function decreaseAllowance(address[2] memory addressArr, uint[2] memory uintArr) public virtual returns (bool success) { //from router
