...
//Private key is to be generated and then copied by hand-writing, without Internet connection, on a separate Virtual Machine, and stored as a top secret in a safe place.
